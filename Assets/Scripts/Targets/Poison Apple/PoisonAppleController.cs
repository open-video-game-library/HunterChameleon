...
public class PoisonAppleController : MonoBehaviour, ITarget
{
    private PoisonAppleParameter parameter;
    ...
    private void Start()
    {
        parameter = ParameterManager.Instance.parameter.target.poisonApple;
    }
