...
[RequireComponent(typeof(Animator), typeof(AppleBehaviour))]
public class GoldAppleController : MonoBehaviour, ITarget
{
    private GoldAppleParameter parameter;

    private Animator animator;
    private AppleBehaviour behaviour;

    public bool IsReward => parameter?.isReward ?? true;
    ...
    private void Start()
    {
        parameter = ParameterManager.Instance.parameter.target.goldApple;
    }
    ...
    private void Init()
    {
        ...
        if (behaviour == null) { behaviour = GetComponent<AppleBehaviour>(); }
